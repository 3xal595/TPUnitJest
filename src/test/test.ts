...
import { getAveragePrice } from "../BookPriceService"; // Importer la fonction getAveragePrice

describe('BookCollection', () => {
  let bookManager: BookCollection;
  ...
  beforeEach(() => {
    bookManager = new BookCollection();
  });
...
describe("BookCollection Advanced Price API", () => {
  it("Should use Price API", () => {
    const price = getAveragePrice(); // Utiliser la fonction directement
